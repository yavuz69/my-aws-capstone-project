...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.cb8apiwskrrk.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'byawsblog' # please enter your s3 bucket name
